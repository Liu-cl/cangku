...
public class Course {
	...
	private String course_total_time;//总学时
	
	private String course_teach_time;//教授学时
	
	private String course_exp_time;//实验学时
	
	private String course_prac_time;//实习学时
	
	private String course_comp_time;//上机学时
	...
	public String get_Course_Teach_Time () {
		return course_teach_time;
	}
	
	public String get_Course_Exp_Time () {
